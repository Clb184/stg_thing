...
&fdl = &fdl
{
  var l: number = 7 - ((6 * winheight(0) + 24) / 48)
  if l < 1 | l = 1 | endif
  keepjumps exe ":" .. l
  normal! zt
  keepjumps :7
...
&fdl = &fdl
{
  var l: number = 11 - ((10 * winheight(0) + 24) / 48)
  if l < 1 | l = 1 | endif
  keepjumps exe ":" .. l
  normal! zt
  keepjumps :11
...
&fdl = &fdl
{
  var l: number = 63 - ((5 * winheight(0) + 24) / 48)
  if l < 1 | l = 1 | endif
  keepjumps exe ":" .. l
  normal! zt
  keepjumps :63
